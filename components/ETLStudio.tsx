...
import { Database, ArrowRight, Play, RefreshCw, Server, FileJson, FileSpreadsheet, Download, Activity, CheckCircle2, Settings, Plus, Cable, GitMerge, ListFilter, Grid, Search, X, Layers, Workflow, HardDrive } from 'lucide-react';
import { AreaChart, Area, XAxis, YAxis, CartesianGrid, Tooltip, ResponsiveContainer } from 'recharts';
import { ETLPipeline } from '../types';
import { runETLTransformation } from '../services/geminiService';

const ETLStudio: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'PIPELINES' | 'DESIGNER' | 'CONNECTORS' | 'MONITOR'>('PIPELINES');
